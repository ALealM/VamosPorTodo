...
{!! Form::model( @$oInventario, ['route' =>[ 'storeIndicador' ],'method' => ( 'POST'), 'class'=>'form-horizontal','id'=>'form', 'accept-charset' => "UTF-8", 'enctype' => "multipart/form-data" ]) !!}
<div class="row">
    <div class="col-md-6">
                ...
                <tr>
                    <td>
                        <div class="form-group" style="margin-bottom: 10px">
                            {!! Form::select('id_eje',$ejes,null,['class'=>'form-control','required','placeholder'=>'Seleccione el eje...','required','onchange'=>'getEstrategias()','id'=>'id_eje']) !!}<i class="form-group__bar"></i>
                        </div>
                    </td>
                </tr>
            </tbody>
        ...
        <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="form-group" style="margin-bottom: 10px">
                            {!! Form::select('id_estrategia',[],null,['class'=>'form-control','required','placeholder'=>'Seleccione la estrategia...','required','id'=>'estrategia']) !!}<i class="form-group__bar"></i>
                        </div>
                    </td>
                </tr>
            </tbody>
