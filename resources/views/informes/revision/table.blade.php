            ...
            <td class="text-center">
                <div class="btn-group m-0" role="group">
                    ...
                    <div class="dropdown-menu">
                        <a href="{{url('/informe/showRevision/'.$informe->fecha_informe)}}" class="col-12 btn btn-secondary btn-sm"><i class="fa fa-eye mr-2"></i>Ficha</a><br>
                        <a href="{{url('/informe/revisar/'.$informe->fecha_informe)}}" class="col-12 btn btn-secondary btn-sm"><i class="fa fa-check-circle-o mr-2"></i>Revisar</a><br>
