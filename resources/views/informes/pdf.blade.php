    ...
    <body>
        ...
        <main>
            <div style="padding-top: 0px; font-family: 'Times New Roman', Times, serif">
                ...
                <div style="text-align: right; padding: 5px; margin: 0px"><p style="font-size: 16px; padding: 0px; margin: 0px"><b>FECHA:</b> {{ date('j', strtotime($fecha)) }} de {{ $meses[date('n', strtotime($fecha))-1] }} de {{ date('Y', strtotime($fecha)) }}</p></div>
                <div style=" width: 100%;">
                    @foreach($informes as $informe)
                    <div>
                        <h3 style="padding-bottom: 0px; margin-bottom: 0px">{!! $informe->direccion()->direccion!!}</h3><hr style="padding-top: 0px; margin-top: 0px; border-top: 0px solid gray;">
