...
{!! Form::model( @$oInventario, ['route' =>[ 'storeBeneficiario' ],'method' => ( 'POST'), 'class'=>'form-horizontal','id'=>'form', 'accept-charset' => "UTF-8", 'enctype' => "multipart/form-data"]) !!}
{{ Form::hidden('id_programa',$programa->id) }}
<div class="row">
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12 text-center">
        ...
        <a class="btn btn-danger btn-sm" href="{{url('/programas')}}"><i class="fa fa-times"></i> Cancelar</a>
    </div>
</div>
