            ...
            <td class="text-center">
                <div class="btn-group m-0" role="group">
                    ...
                    <div class="dropdown-menu">                        
                        <a href="{{url('/beneficiario/edit/'.$beneficiario->id)}}" class="col-12 btn btn-secondary btn-sm"><i class="fa fa-edit mr-2"></i>Edición</a><br>       
                        <a href="{{url('/beneficiario/delete/'.$beneficiario->id)}}" class="col-12 btn btn-secondary btn-sm"><i class="fa fa-times mr-2"></i>Eliminar</a><br>                               
