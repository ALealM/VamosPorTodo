...
@section('content')
	...
	{!! Form::model( @$ecologia, ['route' =>[ 'updateEcologia' ], 'method' => ( 'POST'), 'class' =>'form-horizontal', 'id'=>'form', 'accept-charset' => "UTF-8", 'enctype' => "multipart/form-data" ]) !!}

	<input type="hidden" value='{{$ecologia->id}}' name='id'>
								...
								<div class="header-text mb-0">
									<div class="container-fluid p-5">
										<div class="form-group" style="margin-bottom: 10px">
											{!! Form::text('titulo', $ecologia->titulo, ['class'=>'form-control title', 'required', 'placeholder'=>'Escriba el título', 'maxlength' => 100, 'style' => 'text-transform: uppercase;' ]) !!}
						...
						<div class="col-md-2" style="place-self: center; text-align: center;">
							...
							<div class="row row-sm">
								<div class="col-md-6">
			                        ...
			                        <div class="form-group" style="margin-bottom: 10px">
			                            {!! Form::date('fecha_init', $ecologia->fecha_init,[ 'class'=>'form-control', 'required', 'id'=>'fecha_init', 'min' => '2000-01-01', 'style' => 'width: 100%;' ]) !!}
			                            <i class="form-group__bar"></i>
			                        </div>
			                    </div>
								<div class="col-md-6">
			                        ...
			                        <div class="form-group" style="margin-bottom: 10px">
			                            {!! Form::date('fecha_fin', $ecologia->fecha_end,[ 'class'=>'form-control', 'required', 'id'=>'fecha_fin', 'min' => '2000-01-01', 'style' => 'width: 100%;' ]) !!}
			                            <i class="form-group__bar"></i>
			                        </div>
			                    </div>
			                </div>
						...
						<div class="col-md-5" style="background: #fff; padding-top: 1em;">
							...
							<div class="row mb-4" style="justify-content: right;">
								<div class="col-sm-12 col-md-10">
									<input type="file" class="dropify" data-height="200" accept=".jpg, .png, image/jpeg, image/png" name="mainImage" data-default-file="{{URL::asset('ecologia/'.$ecologia->main_image)}}" />
								</div>
							</div>
								...
								<div class="col-md-12">
									...
									<div class="table-responsive">
										<table class="table-condensed table-hover" style="width: 100%" id="tablaActividades">
											<tbody>
												@foreach($ecologia->listaActividad as $value)
													<tr>
														...
														<td>
															<div class="form-group" style="margin-bottom: 10px">
																...
																{!! Form::text('actividades[]', $value->actividad, ['class'=>'form-control', 'required', 'placeholder'=>'Escriba actividad', 'maxlength' => 500 ]) !!}
														...
														<td>
															...
															@else
																<a class="btn btn-danger btn-sm text-white" style="color: red" onclick="deleteRow(this.parentNode.parentNode.rowIndex )" type="button" style="cursor:pointer"><i class="fa fa-minus-square"></i></a>
															@endif
														</td>
													</tr>
												@endforeach
						...
						<div class="col-md-5" style="background: #00467d; padding-top: 1em;">
							...
							<div class="row mb-4">
								<div class="col-sm-12 col-md-12">
									<input type="file" class="dropify" data-height="200" accept=".jpg, .png, image/jpeg, image/png" name="image2" data-default-file="{{URL::asset('ecologia/'.$ecologia->horizontal_image)}}" />
								</div>
							</div>
							...
							<div class="row row-sm">
								<div class="col-md-6">
									<div class="form-group" style="margin-bottom: 10px">
										{!! Form::text('titulo_cards', @$ecologia->title_cards, ['class'=>'form-control title', 'placeholder'=>'Escriba el título (opcional)', 'maxlength' => 100, 'style' => 'max-width: 90%; text-transform: uppercase;' ]) !!}
										<i class="form-group__bar"></i>
									</div>
								</div>
							</div>
							...
							<div class="row row-sm">
								...
								<div class="col-md-5" style="padding-top: 20em;">
									...
									<div class="row mb-4" style="justify-content: right;">
										<div class="col-sm-12 col-md-10">
											<input type="file" class="dropify" data-height="500" accept=".jpg, .png, image/jpeg, image/png" name="image3" data-default-file="{{URL::asset('ecologia/'.$ecologia->vertical_image)}}" />
										</div>
									</div>
								</div>
							</div>
