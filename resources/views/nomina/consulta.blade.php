@extends('layouts.app',['activePage' => 'consulta', 'mainPage' => 'nomina'])
                    ...
                    <tr>
                        <td>
                            <div class="form-group col-md-10 mr-auto ml-auto" style="margin-bottom: 0px; margin-top: 0px">
                                {!! Form::select('anio',['2022'=>'2022'],'2022',['class'=>'form-control select2','placeholder'=>'Seleccione el año...']) !!}<i class="form-group__bar"></i>
                            </div>
                        </td>
                    </tr>
                </tbody>
                    ...
                    <tr>
                        <td>
                            <div class="form-group col-md-12" style="margin-bottom: 0px; margin-top: 0px">
                                {!! Form::select('quincena',$quincenas,null,['class'=>'form-control select2','id'=>'quincena']) !!}<i class="form-group__bar"></i>
                            </div>
                        </td>
                    </tr>
                </tbody>
            ...
            <table class="dataTable table-borderless table-condensed" style="width: 100%">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="form-group col-md-12" style="margin-bottom: 0px; margin-top: 0px">
                                {!! Form::select('direccion',$direcciones,null,['class'=>'form-control select2','id'=>'direccion','placeholder'=>'Seleccione la dirección...','onchange'=>'getDeptos()']) !!}<i class="form-group__bar"></i>
                            </div>
                        </td>
                    </tr>
                </tbody>
            ...
            <table class="dataTable table-borderless table-condensed" style="width: 100%">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="form-group col-md-12" style="margin-bottom: 0px; margin-top: 0px">
                                {!! Form::select('depto',$departamentos,null,['class'=>'form-control select2','id'=>'depto','placeholder'=>'Seleccione el departamento...']) !!}<i class="form-group__bar"></i>
                            </div>
                        </td>
                    </tr>
                </tbody>
            ...
            <table class="dataTable table-borderless table-condensed" style="width: 100%">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="form-group col-md-12" style="margin-bottom: 0px; margin-top: 0px">
                                {!! Form::select('puesto',$puestos,null,['class'=>'form-control select2','placeholder'=>'Seleccione el puesto...','id'=>'puesto']) !!}<i class="form-group__bar"></i>
                            </div>
                        </td>
                    </tr>
                </tbody>
            ...
            <table class="dataTable table-borderless table-condensed" style="width: 100%">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="form-group col-md-12" style="margin-bottom: 0px; margin-top: 0px">
                                {!! Form::date('fecha_i',null,['class'=>'form-control','id'=>'fecha_i']) !!}<i class="form-group__bar"></i>
                            </div>
                        </td>
                    </tr>
                </tbody>
            ...
            <table class="dataTable table-borderless table-condensed" style="width: 100%">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="form-group col-md-12" style="margin-bottom: 0px; margin-top: 0px">
                                {!! Form::date('fecha_f',null,['class'=>'form-control','id'=>'fecha_f']) !!}<i class="form-group__bar"></i>
                            </div>
                        </td>
                    </tr>
                </tbody>
            ...
            <table class="dataTable table-borderless table-condensed" style="width: 100%">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="form-group col-md-12" style="margin-bottom: 0px; margin-top: 0px">
                                {{ Form::select('orden',$orden,null,['class'=>'form-control select2','id'=>'orden']) }}<i class="form-group__bar"></i>
                            </div>
                        </td>
                    </tr>
                </tbody>
            ...
            <table class="dataTable table-borderless table-condensed" style="width: 100%">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="form-group col-md-12" style="margin-bottom: 0px; margin-top: 0px">
                                {{ Form::select('pensionados',['1'=>'Sin pensionados','2'=>'Con pensionados'],2,['class'=>'form-control select2','id'=>'pensionados']) }}<i class="form-group__bar"></i>
                            </div>
                        </td>
                    </tr>
                </tbody>
