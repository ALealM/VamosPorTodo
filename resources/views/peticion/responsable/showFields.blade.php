        ...
        <table class="table-hover" style="width: 100%; margin-bottom: 30px;" id="tablaBeneficiarios">
            <tbody>
                <tr style="background-color:#ddd">
                    ...
                    <td colspan="5">{{ $responsable->avance }}%</td>
                    <th style="text-align: center">Evidencias:</th>
                    @if(isset($evidencia->archivo))
                    <td><a href="{{asset('/archivos/responsable')}}/{{ $evidencia->archivo }}" target="_blank" class="btn btn-sm">ANEXO</a></td>
                    @else
                    <td>Sin evidencia</td>
                    @endif
                </tr>
                <tr>
                    ...
                    @if(isset($evidencia->reporte))
                    <td>{{ $evidencia->reporte }}</td>
                    @else
                    <td>Sin reporte</td>
                    @endif
                </tr>
