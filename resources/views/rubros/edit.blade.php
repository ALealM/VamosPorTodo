...
{!! Form::model( @$rubro, ['route' =>[ 'updateRubro' ],'method' => ( 'PUT'), 'class'=>'form-horizontal','id'=>'form', 'accept-charset' => "UTF-8", 'enctype' => "multipart/form-data" ]) !!}
{{Form::hidden('id')}}
<div class="row">
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group" style="margin-bottom: 5px;padding-bottom: 0px;">
                            {!! Form::text('nombre',null,['class'=>'form-control','required','placeholder'=>'Escriba el nuevo nombre del rubro']) !!}<i class="form-group__bar"></i>
                        </div>
                    </td>
                </tr>
            </tbody>
