...
@section('content')
  {!! Form::model( @$colonia, ['route' =>[ 'updateColonia' ],'method' => ( 'PUT'), 'class'=>'form-horizontal','id'=>'form', 'accept-charset' => "UTF-8", 'enctype' => "multipart/form-data" ]) !!}
  {{Form::hidden('id')}}
  <div class="row">
    <div class="col-md-6">
          ...
          <tr>
            <td>
              <div class="form-group" style="margin-bottom: 10px">
                {!! Form::text('nombre',null,['class'=>'form-control','required','placeholder'=>'Escriba el nuevo nombre de la colonia','required' ]) !!}<i class="form-group__bar"></i>
              </div>
            </td>
          </tr>
        </tbody>
