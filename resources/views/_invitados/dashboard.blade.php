...
@section('content')
    ...
    <script type="text/javascript">
        $(function () {
            /* Pie Chart*/
            var inv_f_m = new Chart(document.getElementById('chartDonut'), {
                type: 'pie',
                data: {
                    labels: ['Femenino', 'Masculino'],
                    datasets: [{
                        data: [{{$female}}, {{$male}}],
                        backgroundColor: ['#EB92BE', '#3DB2FF']
                    }]
                },
                options: {
            ...
            var asis_f_m = new Chart(document.getElementById('chartDonut2'), {
                type: 'pie',
                data: {
                    labels: ['Femenino', 'Masculino'],
                    datasets: [{
                        data: [{{$asistioFemale}}, {{$asistioMale}}],
                ...
                options: {
                    ...
                    title: {
                        display: true,
                        text: '{{$asistioFemale}}                          {{$asistioMale}}'
                    }
                }
            });
        });
