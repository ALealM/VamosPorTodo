@extends('layouts.app', ['activePage' => 'asistentesInvitados'])
@section('content')
<style>
.dataTables_wrapper {
...
<div style="display:inline-block; text-align:center; width:100%;">
    ...
    <div class="list">
      <table class="table tile thead-dark dataTable table-striped responsive" role='grid' style="background-color: #292942; color:#fff;">
        ...
        <tr>
					<td style="font-size: 12px; width:20%; text-align:center;">{{ $asis->nombre }}</td>
          <td style="font-size: 12px; width:20%; text-align:center;">{{ $asis->dependencia }}</td>
          <td style="font-size: 12px; width:10%; text-align:center;">{{ $asis->puesto }}</td>
          <td style="width:30%; text-align:center;">{{ $asis->lugar }}</td>
        </tr>
				@endforeach
			</tbody>
      </table>
