@extends('layouts.app', ['activePage' => 'editProyectoAccion'])
...
{!! Form::model( @$proyAcc, ['route' =>[ 'updateProyectoAccion' ],'method' => ( 'PUT'), 'class'=>'form-horizontal','id'=>'form', 'accept-charset' => "UTF-8", 'enctype' => "multipart/form-data" ]) !!}
{{Form::hidden('id')}}
<div class="row">
        ...
        <table class="dataTable table-borderless table-condensed" style="width: 100%">
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="form-group" style="margin-bottom: 10px">
                            {!! Form::select('rubro',$rubros,null,['class'=>'form-control','required','placeholder'=>'Seleccione el rubro del gasto...','id'=>'rubro','onchange'=>'getConceptos()']) !!}<i class="form-group__bar"></i>
                        </div>
                    </td>
                </tr>
            </tbody>
        ...
        <table class="dataTable table-borderless table-condensed" style="width: 100%">
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="form-group" style="margin-bottom: 10px">
                            {!! Form::select('id_concepto',$conceptos,null,['class'=>'form-control','required','placeholder'=>'Seleccione el concepto del gasto...','id'=>'concepto']) !!}<i class="form-group__bar"></i>
                        </div>
                    </td>
                </tr>
            </tbody>
            ...
            <table class="dataTable table-borderless table-condensed" style="width: 100%">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="form-group" style="margin-bottom: 10px">
                                {!! Form::text('inversionTot',null,['class'=>'form-control','id'=>'inversionTot','disabled','style'=>'cursor:default']) !!}<i class="form-group__bar"></i>
                            </div>
                        </td>
                    </tr>
                </tbody>
        ...
        <table class="dataTable table-borderless table-condensed" style="width: 100%">
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="form-group" style="margin-bottom: 10px">
                            {!! Form::text('estructura[]',$proyAcc->federal,['class'=>'form-control est','placeholder'=>'Monto Federal','onkeyup'=>'inversionTotal()','onKeyPress'=>'return isNumberCant(event,"0.00",9,2)']) !!}<i class="form-group__bar"></i>
                        </div>
                    </td>
                </tr>
            </tbody>
        ...
        <table class="dataTable table-borderless table-condensed" style="width: 100%">
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="form-group" style="margin-bottom: 10px">
                            {!! Form::text('estructura[]',$proyAcc->estatal,['class'=>'form-control est','placeholder'=>'Monto Estatal','onkeyup'=>'inversionTotal()','onKeyPress'=>'return isNumberCant(event,"0.00",9,2)']) !!}<i class="form-group__bar"></i>
                        </div>
                    </td>
                </tr>
            </tbody>
        ...
        <table class="dataTable table-borderless table-condensed" style="width: 100%">
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="form-group" style="margin-bottom: 10px">
                            {!! Form::text('estructura[]',$proyAcc->municipal,['class'=>'form-control est','placeholder'=>'Monto Municipal','onkeyup'=>'inversionTotal();verificacionMunicipal()','onKeyPress'=>'return isNumberCant(event,"0.00",9,2)','id'=>'municipal']) !!}<i class="form-group__bar"></i>
                        </div>
                    </td>
                </tr>
            </tbody>
        ...
        <table class="dataTable table-borderless table-condensed" style="width: 100%">
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="form-group" style="margin-bottom: 10px">
                            {!! Form::text('estructura[]',$proyAcc->otros,['class'=>'form-control est','placeholder'=>'Monto Otros','onkeyup'=>'inversionTotal()','onKeyPress'=>'return isNumberCant(event,"0.00",9,2)']) !!}<i class="form-group__bar"></i>
                        </div>
                    </td>
                </tr>
            </tbody>
        ...
        <table class="dataTable table-borderless table-condensed" style="width: 100%">
            <tbody>
                <tr style="padding-bottom:0px">
                    <th>
                        <div>{{$mes->mes}}:<span id='mes{{$mes->id}}P' class="pull-right"></span></div>
                    </th>
                </tr>
                <tr style="padding-bottom:0px; padding-top:0px; margin-bottom:0px; margin-top:0px;">
                    <td>
                        <div class="form-group" style="padding-bottom:10px; padding-top:0px; margin-bottom:0px; margin-top:0px;">
                            {!! Form::text('mes[]',$mes->monto,['class'=>'form-control mes','placeholder'=>'Monto de '.$mes->mes,'onKeyPress'=>'return isNumberCant(event,"0.00",9,2)','onkeyup'=>'verificacionMunicipal()','id'=>'mes'.$mes->id]) !!}<i class="form-group__bar"></i>
                        </div>
                    </td>
                </tr>
            </tbody>
        ...
        <table class="dataTable table-borderless table-condensed" style="width: 100%">
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="form-group" style="margin-bottom: 10px">
                            {!! Form::select('id_objetivo',$objetivos,null,['class'=>'form-control','required','placeholder'=>'Seleccione el Objetivo de Desarrollo Sostenible...','id'=>'objetivos']) !!}<i class="form-group__bar"></i>
                        </div>
                    </td>
                </tr>
            </tbody>
...
<script>
    ...
    function inversionTotal() {
        ...
        $( ".est" ).each(function( est ) {
            ...
            $('#inversionTot').val('$ '+addCommas(Math.round(totInv*100)/100));
        });
    }
    ...
    function verificacionMunicipal() {
        ...
        $( ".mes" ).each(function( mes ) {
            ...
            if($('#validacionH').val() != $('#municipal').val()*1){
