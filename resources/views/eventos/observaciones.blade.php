@extends('layouts.app', ['activePage' => 'showObservaciones', 'mainPage' => 'eventos'])
@section('title', 'Main page')
@section('content')

{!! Form::model( @$evento, ['route' =>[ 'storeObservaciones' ],'method' => ( 'POST'), 'class'=>'form-horizontal','id'=>'form', 'accept-charset' => "UTF-8", 'enctype' => "multipart/form-data" ]) !!}
...
<div class="row">
    <div class="col-md-8 mr-auto ml-auto" style="padding-top: 15px">
        <h4 style="text-align: center">ESTATUS</h4>
        <table class="table table-hover table-bordered" style="width: 100%; text-align: center" id="tablaBeneficiarios">
            <tbody>
                <tr>
                    <td>
                        <input type="radio" class="btn-check" name="estatus" id="info-outlined" autocomplete="off" checked value="2">
                        <label class="btn btn-info btn-sm" for="info-outlined">EN REVISIÓN</label>
                    </td>
                    <td>
                        <input type="radio" class="btn-check" name="estatus" id="success-outlined" autocomplete="off" value="3">
                        <label class="btn btn-success btn-sm" for="success-outlined">AUTORIZADO</label>
                    </td>
                    <td>
                        <input type="radio" class="btn-check" name="estatus" id="danger-outlined" autocomplete="off" value="4">
                        <label class="btn btn-danger btn-sm" for="danger-outlined">NO AUTORIZADO</label>
                    </td>
                </tr>
            </tbody>
        </table>
...
<div class="row">
    <div class="col-md-8 mr-auto ml-auto" style="padding-top: 15px">
        ...
        <div class="form-group" style="margin-bottom: 10px">
            {!! Form::textarea('observaciones',null,['class'=>'form-control form-control-sm','rows'=>'3','placeholder'=>'Observaciones del evento...']) !!}<i class="form-group__bar"></i>
        </div>
    </div>
</div>
<div class="row">
