@extends('layouts.app', ['activePage' => 'reporteEventoColaboracion', 'mainPage' => 'eventos'])
@section('title', 'Main page')
@section('content')

{!! Form::model( @$evento, ['route' =>[ 'storeReporteColaboracion' ],'method' => ( 'POST'), 'class'=>'form-horizontal','id'=>'form', 'accept-charset' => "UTF-8", 'enctype' => "multipart/form-data" ]) !!}
