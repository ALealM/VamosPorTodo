            ...
            <td class="text-center">
                <div class="btn-group m-0" role="group">
                    ...
                    <div class="dropdown-menu"> 
                        <a href="{{url('/evento/reporteColaboracion/'.$evento->id)}}" class="col-12 btn btn-secondary btn-sm"><i class="fa fa-list-ol mr-2"></i>Reporte</a><br>
                        <a href="{{url('/evento/showColaboracion/'.$evento->id)}}" class="col-12 btn btn-secondary btn-sm"><i class="fa fa-eye mr-2"></i>Ficha</a><br>
