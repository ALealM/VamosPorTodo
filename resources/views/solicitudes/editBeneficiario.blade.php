...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12 text-center">
        <br>
        <span style=" font-weight: 600">EDICIÓN DE BENEFICIARIO</span><hr>
    </div>
</div>
{!! Form::model( @$beneficiario, ['route' =>[ 'updateBeneficiarioSol' ],'method' => ( 'PUT'), 'class'=>'form-horizontal','id'=>'form', 'accept-charset' => "UTF-8", 'enctype' => "multipart/form-data"]) !!}
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12 text-center">
        ...
        <a class="btn btn-danger btn-sm" href="{{url('/solicitud/show/'.$solicitud->id)}}"><i class="fa fa-times"></i> Cancelar</a>
    </div>
</div>
