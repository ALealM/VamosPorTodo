...
{!! Form::model( @$oInventario, ['route' =>[ 'storeSolicitud' ],'method' => ( 'POST'), 'class'=>'form-horizontal','id'=>'form', 'accept-charset' => "UTF-8", 'enctype' => "multipart/form-data" ]) !!}
<div class="row">
    <div class="col-md-12">
        ...
        <table class="table-borderless table-condensed table-hover" style="width: 100%">
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="form-group" style="margin-bottom: 10px">
                            {!! Form::date('day', date('Y-m-d'), ['class'=>'form-control', 'required' ]) !!} <i class="form-group__bar"></i>
                        </div>
                    </td>
                </tr>
            </tbody>
