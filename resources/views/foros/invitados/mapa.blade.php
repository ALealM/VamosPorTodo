@extends('layouts.app', ['activePage' => 'mapaInvitados'])
@section('content')
<style>
.dataTables_wrapper {
...
<div style="display:inline-block; text-align:center; width:100%;">
    ...
    <div class="list">
      <table class="table tile thead-dark  responsive" role='grid' style="background-color: #292942; color:#fff;">
				<thead style="background: rgba(255,255,255,.1); color:#fff; border-radius: 5em;">
					<tr style="text-align:center;">
						<td><img src="../images/LugaresCopladem.png" style="width: 80%;"></td>
					</tr>
				</thead>
				<tbody>
			</tbody>
