@extends('layouts.app', ['activePage' => 'indexPrimer'])
@section('content')
<style>
    .dataTables_wrapper {
...
<div class="list" style="text-align:center; cursor:pointer" onclick="addInvitadoPrimer()">
...
<script>
    ...
    function addInvitadoPrimer(){
        window.location.href = BASE_URL + "addInvitadoPrimer";
    }
</script>
