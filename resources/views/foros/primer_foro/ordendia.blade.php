@extends('layouts.app', ['activePage' => 'ordenPrimer'])
@section('content')
<style>
.dataTables_wrapper {
        ...
        <table style="width:100%">
            <thead>
                <tr style="text-align:center;">
                    <th colspan="3" >
                        LUGAR Y FECHA:	CENTRO DE LAS ARTES	SALA 2	25 DE NOVIEMBRE DE 2021
                    </th>
                </tr>
                <tr>
                    <th colspan="3">
                        HORA INICIO:	16:00 Hrs	TÉRMINO	18:30 p. m.	CÓDIGO VESTIMENTA	CASUAL
                    </th>
                </tr>
            </thead>
            <tbody  style="text-align:left;">
                ...
                <tr style="padding:3px;">
                    ...
                    <td style="padding-right: 10px; margin-right: 10px">
                        Intervención de la Dirección General de Seguridad Pública Municipal
                    </td>
                    <td>
                        Comisario Villa
                    </td>
                ...
                <tr style="padding:3px;">
                    ...
                    <td style="padding-right: 10px; margin-right: 10px">
                        Intervención de la Dirección Municipal de Instancia de la Mujer
                    </td>
                    <td>
                        Guadalupe Almaguer
                    </td>
                ...
                <tr style="padding:3px;">
                    ...
                    <td style="padding-right: 10px; margin-right: 10px">
                        Intervención del Regidor Rodolfo Edgardo Jasso Puente
                    </td>
                    <td>
                ...
                <tr style="padding:3px;">
                    ...
                    <td style="padding-right: 10px; margin-right: 10px">
                        Intervención del Dr. Álvaro Vizcaíno
                    </td>
                    <td>
                        Orador huésped
                    </td>
