@extends('layouts.app', ['activePage' => 'ordenSostenible', 'mainPage' => 'sostenible'])
@section('content')
<style>
.dataTables_wrapper {
        ...
        <table style="width:100%">
            <thead>
                <tr style="text-align:center;">
                    <th colspan="3" >
                        LUGAR Y FECHA:	CENTRO UNIÓN	SALA 2	26 DE NOVIEMBRE DE 2021
                    </th>
                </tr>
                <tr>
                    <th colspan="3">
                        HORA INICIO:	17:00 Hrs	TÉRMINO	19:00 p. m.	CÓDIGO VESTIMENTA	CASUAL
                    </th>
                </tr>
            </thead>
