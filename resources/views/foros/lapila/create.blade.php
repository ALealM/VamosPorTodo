@extends('layouts.app', ['activePage' => 'altaLapila', 'mainPage' => 'lapila'])
...
{!! Form::model( @$oInventario, ['route' =>[ 'storeInvitadoLapila' ],'method' => ( 'POST'), 'class'=>'form-horizontal','id'=>'form', 'accept-charset' => "UTF-8", 'enctype' => "multipart/form-data"]) !!}
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12 text-center">
        ...
        <a class="btn btn-secondary" href="{{url('/lapila/index')}}"><i class="fa fa-arrow-circle-left mr-2"></i>Regresar</a>
    </div>
</div>
<script>
