@extends('layouts.app', ['activePage' => 'indexLapila', 'mainPage' => 'lapila'])
@section('content')
<style>
    .dataTables_wrapper {
...
@if(\Auth::User()->tipo == 0 || \Auth::User()->tipo == 9  || \Auth::User()->id == 72)
...
<script>
    function asistencia(id){
        ...
        $.get(BASE_URL + "asistenciaLapila", {'check': check, 'id': id}, function (r) {
            $('#numAsis').empty();
            $('#numInt').empty();
    ...
    function addInvitado(){
        window.location.href = BASE_URL + "addInvitadoLapila";
    }
</script>
