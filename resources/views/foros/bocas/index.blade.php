@extends('layouts.app', ['activePage' => 'indexBocas', 'mainPage' => 'bocas'])
@section('content')
<style>
    .dataTables_wrapper {
...
@if(\Auth::User()->tipo == 0 || \Auth::User()->tipo == 8  || \Auth::User()->id == 72)
...
<script>
    function asistencia(id){
        ...
        $.get(BASE_URL + "asistenciaBocas", {'check': check, 'id': id}, function (r) {
            $('#numAsis').empty();
            $('#numInt').empty();
    ...
    function addInvitado(){
        window.location.href = BASE_URL + "addInvitadoBocas";
    }
</script>
