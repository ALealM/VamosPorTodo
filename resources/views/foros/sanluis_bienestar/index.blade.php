@extends('layouts.app', ['activePage' => 'indexBienestar', 'mainPage' => 'bienestar'])
@section('content')
<style>
    .dataTables_wrapper {
...
<script>
    function asistencia(id){
        ...
        $.get(BASE_URL + "asistenciaBienestar", {'check': check, 'id': id}, function (r) {
            $('#numAsis').empty();
            $('#numInt').empty();
    ...
    function addInvitado(){
        window.location.href = BASE_URL + "addInvitadoBienestar";
    }
</script>
