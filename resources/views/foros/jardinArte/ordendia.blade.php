@extends('layouts.app', ['activePage' => 'ordenJardinArte', 'mainPage' => 'jardin_arte'])
@section('content')
<style>
.dataTables_wrapper {
        ...
        <table style="width:100%">
            <thead>
                <tr style="text-align:center;">
                    <th colspan="3" >
                        LUGAR Y FECHA:	JARDÍN DE TEQUIS	28 DE NOVIEMBRE DE 2021
                    </th>
                </tr>
                <tr>
                    <th colspan="3">
                        HORA INICIO:	12:00 Hrs	TÉRMINO	16:00 Hrs	CÓDIGO VESTIMENTA	CASUAL
                    </th>
                </tr>
            </thead>
            <tbody  style="text-align:left;">
                <tr style="padding:3px; border-bottom: 1px solid">
                    <td style="padding-right: 10px; margin-right: 10px"><b>HORA</b></td>
                    <td style="padding-right: 10px; margin-right: 10px"><b>ACTIVIDAD</b></td>
                    <td><b>PRESENTADOR</b></td>
                </tr>
                ...
                <tr style="padding:3px;">
                    ...
                    <td style="padding-right: 10px; margin-right: 10px">
                        Intervención de la Dirección de Servicios Municipales
                    </td>
                    <td>
                        Christian Azuara
                    </td>
                ...
                <tr style="padding:3px;">
                    ...
                    <td style="padding-right: 10px; margin-right: 10px">
                        Intervención de la Dirección General de Gestión Territorial y Catastro
                    </td>
                    <td>
                ...
                <tr style="padding:3px;">
                    ...
                    <td style="padding-right: 10px; margin-right: 10px">
                        Intervención de la Dirección de Gestión Ecológica y Manejo de Residuos
                    </td>
                    <td>
                ...
                <tr style="padding:3px;">
                    ...
                    <td style="padding-right: 10px; margin-right: 10px">
                        Orador huésped de la Dirección de Ecología
                    </td>
                    <td>
                        Dr.Marcos Algara Siller - Director de la<br> Agenda Ambiental de la UASLP.
                    </td>
                </tr>
                <tr style="padding:3px;">
                    <td style="padding-right: 10px; margin-right: 10px">
                ...
                <tr style="padding:3px;">
                    ...
                    <td style="padding-right: 10px; margin-right: 10px">
                        Intervención de la ciudadanía, llenado y recolección de papeletas
                    </td>
                    <td>
                        Maestro de Ceremonias/Moderador
                    </td>
                </tr>
                <tr style="padding:3px;">
                    <td style="padding-right: 10px; margin-right: 10px">
