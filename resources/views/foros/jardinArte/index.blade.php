@extends('layouts.app', ['activePage' => 'indexJardinArte', 'mainPage' => 'jardin_arte'])
@section('content')
<style>
    .dataTables_wrapper {
...
<script>
    function asistencia(id){
        ...
        $.get(BASE_URL + "asistenciaJardinArte", {'check': check, 'id': id}, function (r) {
            $('#numAsis').empty();
            $('#numInt').empty();
    ...
    function addInvitado(){
        window.location.href = BASE_URL + "addInvitadoJardinArte";
    }
</script>
