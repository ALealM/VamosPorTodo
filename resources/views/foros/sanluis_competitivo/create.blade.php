@extends('layouts.app', ['activePage' => 'altaCompetitivo', 'mainPage' => 'competitivo'])
...
{!! Form::model( @$oInventario, ['route' =>[ 'storeInvitadoCompetitivo' ],'method' => ( 'POST'), 'class'=>'form-horizontal','id'=>'form', 'accept-charset' => "UTF-8", 'enctype' => "multipart/form-data"]) !!}
    ...
    <div class="col-md-12">
        <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
            <tbody>
                <tr>
                    <th>
                        ¿Cómo se enteró del foro? <small style="color: red"><br><b>*Sólo para registro de ciudadanos</b></small>
                    </th>
                </tr>
                <tr>
                    <td>
    ...
    <div class="col-md-12">
        <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
            <tbody>
                <tr>
                    <th>
                        Giro <small style="color: red"><br><b>*Sólo empresarios invitados</b></small>
                    </th>
                </tr>
                <tr>
                    <td>
                        <div class="form-group" style="margin-bottom: 10px">
                            {!! Form::text('giro',null,['class'=>'form-control','placeholder'=>'Ingrese el giro del asistente','id'=>'giro','onkeyup'=>"upper('divulgacion')"]) !!}<i class="form-group__bar"></i>
                        </div>
                    </td>
                </tr>
            </tbody>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12 text-center">
        ...
        <a class="btn btn-secondary" href="{{url('/sanluis_competitivo/index')}}"><i class="fa fa-arrow-circle-left mr-2"></i>Regresar</a>
    </div>
</div>
<script>
