@extends('layouts.app', ['activePage' => 'ordenCompetitivo', 'mainPage' => 'competitivo'])
@section('content')
<style>
.dataTables_wrapper {
...
<div style="display:inline-block; text-align:center; width:100%;">
	...
	<div style="text-align:center;">
	  <h3>FORO SAN LUIS COMPETITIVO </h3>
	  <h4>ORDEN DEL DÍA</h4>
		<p>
        ...
        <table style="width:100%">
            <thead>
                <tr style="text-align:center;">
                    <th colspan="3" >
                        LUGAR Y FECHA:	CANACINTRA	29 DE NOVIEMBRE DE 2021
                    </th>
                </tr>
                <tr>
                    <th colspan="3">
                        HORA INICIO:	17:00 Hrs	TÉRMINO	19:00 Hrs	CÓDIGO VESTIMENTA	CASUAL
                    </th>
                </tr>
            </thead>
            <tbody  style="text-align:left;">
                ...
                <tr style="padding:3px;">
                    ...
                    <td style="padding-right: 10px; margin-right: 10px">
                        Intervención del Director de Desarrollo Económico
                    </td>
                    <td>
                ...
                <tr style="padding:3px;">
                    ...
                    <td style="padding-right: 10px; margin-right: 10px">
                        Intervención del Director de Obras Publicas 
                    </td>
                    <td>
                ...
                <tr style="padding:3px;">
                    ...
                    <td style="padding-right: 10px; margin-right: 10px">
                        Intervención del Presidente de CANACINTRA 
                    </td>
                    <td>
                        Dr. Carlos Mendizábal Pérez
                    </td>
                </tr>
                <tr style="padding:3px;">
                    <td style="padding-right: 10px; margin-right: 10px">
                    ...
                    <td style="padding-right: 10px; margin-right: 10px">
                        Intervención Regidora 
                    </td>
                    <td>
                        María de los Ángeles Hermosillo Casas
                    </td>
                </tr>
                <tr style="padding:3px;">
                    <td style="padding-right: 10px; margin-right: 10px">
                ...
                <tr style="padding:3px;">
                    ...
                    <td style="padding-right: 10px; margin-right: 10px">
                        Interacción invitadxs, llenado y recolección de papeletas.
                    </td>
                    <td>
