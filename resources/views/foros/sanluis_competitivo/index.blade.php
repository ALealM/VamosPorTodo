@extends('layouts.app', ['activePage' => 'indexCompetitivo', 'mainPage' => 'competitivo'])
@section('content')
<style>
    .dataTables_wrapper {
...
<script>
    function asistencia(id){
        ...
        $.get(BASE_URL + "asistenciaCompetitivo", {'check': check, 'id': id}, function (r) {
            $('#numAsis').empty();
            $('#numInt').empty();
    ...
    function addInvitado(){
        window.location.href = BASE_URL + "addInvitadoCompetitivo";
    }
</script>
