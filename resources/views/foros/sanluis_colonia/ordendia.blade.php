@extends('layouts.app', ['activePage' => 'ordenColonia', 'mainPage' => 'colonia'])
@section('content')
<style>
.dataTables_wrapper {
...
<div style="display:inline-block; text-align:center; width:100%;">
	...
	<div style="text-align:center;">
	  <h3>FORO SAN LUIS EN TU COLONIA </h3>
	  <h4>ORDEN DEL DÍA</h4>
		<p>
        ...
        <table style="width:100%">
            <thead>
                <tr style="text-align:center;">
                    <th colspan="3" >
                        LUGAR Y FECHA:	AV. MÉXICO #605	28 DE NOVIEMBRE DE 2021
                    </th>
                </tr>
                <tr>
                    <th colspan="3">
                        HORA INICIO:	10:00 Hrs	TÉRMINO	12:00 p. m.	CÓDIGO VESTIMENTA	CASUAL
                    </th>
                </tr>
            </thead>
