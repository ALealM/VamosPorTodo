@extends('layouts.app', ['activePage' => 'indexColonia', 'mainPage' => 'colonia'])
@section('content')
<style>
    .dataTables_wrapper {
...
<script>
    function asistencia(id){
        ...
        $.get(BASE_URL + "asistenciaColonia", {'check': check, 'id': id}, function (r) {
            $('#numAsis').empty();
            $('#numInt').empty();
    ...
    function addInvitado(){
        window.location.href = BASE_URL + "addInvitadoColonia";
    }
</script>
