@extends('layouts.app', ['activePage' => 'indexPozos', 'mainPage' => 'pozos'])
@section('content')
<style>
    .dataTables_wrapper {
...
@if(\Auth::User()->tipo == 0 || \Auth::User()->tipo == 7  || \Auth::User()->id == 72)
...
<script>
    function asistencia(id){
        ...
        $.get(BASE_URL + "asistenciaPozos", {'check': check, 'id': id}, function (r) {
            $('#numAsis').empty();
            $('#numInt').empty();
    ...
    function addInvitado(){
        window.location.href = BASE_URL + "addInvitadoPozos";
    }
</script>
