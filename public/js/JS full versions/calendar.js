...
var defaults = {
	...
	dayNames: ['Domingi','Lunes','Martes','Miércoles','Jueves','Sábado','Domingo'],
...
function Calendar(element, options, eventSources) {
	...
	function _changeView(newViewName) {
		...
		currentView = new fcViews[newViewName](
			$("<div class='fc-view block fc-view-" + newViewName + "' style='position:relative'/>")
				.appendTo(content),
...
function AgendaView(element, calendar, viewName) {
	...
	function buildSkeleton() {
		...
		slotScroller =
			$("<div class='overflow' style='position:absolute;width:100%;overflow-x:hidden;overflow-y:auto'/>")
				.appendTo(slotLayer);
