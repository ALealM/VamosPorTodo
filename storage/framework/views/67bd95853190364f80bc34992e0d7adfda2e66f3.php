    ...
    <div class="card" style="margin-top: 15px;margin-bottom: 15px;">
        ...
        <div id="collapseID" class="collapse show" aria-labelledby="headingID" data-parent="#accordion">
            <div class="card-body">
                ...
                <?php else: ?>
                <?php echo $__env->make('panel.tableID', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php endif; ?>
            </div>
        </div>
    </div>
    <div class="card" style="margin-top: 15px;margin-bottom: 15px;">
        ...
        <div id="collapseEV" class="collapse show" aria-labelledby="headingEV" data-parent="#accordion">
            <div class="card-body">    
                ...
                <?php else: ?>
                <?php echo $__env->make('panel.tableEV', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php endif; ?>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">    
                <div class="col-md-12 card btn btn-outline-info" style="margin-left: 0px; margin-right: 0px; margin-top: 0px">
                    <div class="card-body row">
                        <div class="col-md-3"><b>Dirección:</b><br><?php echo e(Form::select('direcccion',$direcciones,null,['class'=>'form-control','id'=>'direccion','placeholder'=>'Seleccione dirección...','style'=>'width:100%','onchange'=>'getPOA()'])); ?></div>
                        <div class="col-md-3"><b>Eje Rector:</b><br><?php echo e(Form::select('eje',$ejes,null,['class'=>'form-control','id'=>'eje','placeholder'=>'Seleccione eje...','style'=>'width:100%','onchange'=>'getPOA()'])); ?></div>
                        <div class="col-md-3"><b>Capítulo del Gasto:</b><br><?php echo e(Form::select('capitulo',$capitulos,null,['class'=>'form-control','id'=>'capitulo','placeholder'=>'Seleccione capítulo...','style'=>'width:100%','onchange'=>'getRubros();getPOA()'])); ?></div>
                        <div class="col-md-3"><b>Rubro del Gasto:</b><br><?php echo e(Form::select('rubro',[],null,['class'=>'form-control','id'=>'rubro','placeholder'=>'Seleccione rubro...','style'=>'width:100%','onchange'=>'getPOA()'])); ?></div>
                    </div>
                </div>
                <div id="divPOA">
                    <?php echo $__env->make('panel.tablePOA', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', ['activePage' => 'panel'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>