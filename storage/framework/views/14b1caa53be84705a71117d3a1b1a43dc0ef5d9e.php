...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group" style="margin-bottom: 5px;padding-bottom: 0px; text-align: center">
            ...
            <?php echo Form::select('id_colonia',$colonias,null,['class'=>'form-control select2','required','placeholder'=>'Seleccione la colonia...','id'=>'colonia','onchange'=>'getDatosCol()']); ?><i class="form-group__bar"></i>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', ['activePage' => 'colonias', 'mainPage' => 'programas'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
