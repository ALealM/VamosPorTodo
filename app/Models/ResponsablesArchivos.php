...
class ResponsablesArchivos extends Model
{
    use Notifiable;
     ...
     * @var array
     */
    protected $table = 'responsables_archivos';
    ...
    public static function creaRegistro($data) {
            return ResponsablesArchivos::create([
    ...
    public static function editaRegistro($data) {
        $registro= ResponsablesArchivos::find($data['id']);
