...
class PrimerForoController extends Controller {
    ...
    public function dashboard(){
        ...
        return view('foros.dashboard',compact('invitados','female','male','asistioFemale','asistioMale'))
            ->with('aBreadCrumb',[['link' => 'active', 'label' => 'Dashboard de COPLADEM Primer Foro Seguro']])
            ->with('sTitulo', 'Dashboard')
            ->with('sDescripcion', 'Invitados y Asistentes')
            ->with('activePage', 'primerForoDashboard')
            ->with('mainPage', 'primerForo');
    }
}